...
data = ["Select Category", "Soap (সাবান)", "Shampoo (শ্যাম্পু)", "Face Wash (ফেস ওয়াস)", "Toothpaste (টুথপেস্ট)","Rice (চাল)","Oil (তেল)", "Detergent (ডিটারজেন্ট)","Perfume and Body Spray (পারফিউম ও বডি স্প্রে)",
